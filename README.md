...
This project is a secure web application built using the Django framework, following OWASP-compliant development practices. The application implements a Task Management System with a microservice-inspired architecture, focusing on protecting user data against common web vulnerabilities like SQL Injection and Cross-Site Scripting (XSS)
